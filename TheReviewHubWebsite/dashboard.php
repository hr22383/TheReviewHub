...
if (mysqli_num_rows($productResult) > 0) {
    ...
    echo "<tr><th>Product Photo</th><th>Product Description</th><th>View Review</th><th>Review Count</th><th>Average Rating</th></tr>";
    ...
    while ($row = mysqli_fetch_assoc($productResult)) {
        ...
        if (mysqli_num_rows($reviewsResult) > 0) {
            ...
            // Display the review count and average rating
            echo "<td style='width: 100px; text-align: center;'>" . $reviewCount . "</td>";
            echo "<td style='width: 100px; text-align: center;'>" . round($averageRating, 2) . "</td>";
        } else {
            echo "<div class='reviews'>";
            echo "<p class='no-reviews'>No reviews yet.</p>";
            echo "</div>";

            // Display 0 for review count and average rating
            echo "<td style='width: 100px; text-align: center;'>0</td>";
            echo "<td style='width: 100px; text-align: center;'>0</td>";
        }
